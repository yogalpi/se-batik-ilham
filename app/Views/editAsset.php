                ...
                <div class="card-body">
                  <form action="/update_aset" method="post">
                    <div class="mb-3">
                      ...
                      <input name="kode_aset" value="<?= $aset[0]['kode_aset']; ?>" type="text" class="form-control" id="kode" readonly aria-describedby="emailHelp">
                    </div>
                    <div class="mb-3">
                      <label for="aset" class="form-label">Nama Barang</label>
                      <input name="aset" value="<?= $aset[0]['nama_aset']; ?>" type="text" class="form-control" id="aset">
                    </div>
                    <div class="mb-3">
                      <label for="jenis_aset" class="form-label">Jenis Aset</label>
                      <input name="jenis_aset" value="<?= $aset[0]['jenis_aset']; ?>" type="text" class="form-control" id="jenis_aset">
                    </div>
                    <div class="mb-3">
