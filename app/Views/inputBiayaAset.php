                ...
                <div class="card-body">
                  ...
                  <div class="mb-3 col-3">
                      ...
                      <select name="kode_aset" type="text" class="form-control" id="karyawan" aria-describedby="emailHelp">
                        <option value="0" selected>-- Pilih Aset --</option>
                    ...
                    <div class="mb-3">
                      ...
                      <input name="biaya" type="text" class="form-control" id="biaya" required>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-5 col-3">
                      ...
                      <input name="tanggal" type="date" id="tanggal" class="form-control" id="tanggal" required>
                    </div>
